<template>
  <div class="alert-wrapper">
    ...
    <div class="secondary-alert-box">
      This is a secondary alert ! Please check it out
    </div>
    <div class="success-alert-box">
      This is a success alert ! Please check it out
    </div>
    <div class="danger-alert-box">
      This is a danger alert ! Please check it out
    </div>
    <div class="warning-alert-box">
      This is a warning alert ! Please check it out
    </div>
